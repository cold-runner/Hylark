...
func newPostTag(db *gorm.DB, opts ...gen.DOOption) postTag {
	...
	_postTag.ID = field.NewField(tableName, "id")
	...
	_postTag.TagID = field.NewString(tableName, "tag_id")
	_postTag.PostID = field.NewString(tableName, "post_id")
...
type postTag struct {
	...
	TagID     field.String // 文章所属标签
	PostID    field.String // 博文id
...
func (p *postTag) updateTableName(table string) *postTag {
	...
	p.TagID = field.NewString(table, "tag_id")
	p.PostID = field.NewString(table, "post_id")
