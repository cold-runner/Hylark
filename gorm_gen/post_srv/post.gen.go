...
func newPost(db *gorm.DB, opts ...gen.DOOption) post {
	...
	_post.CategoryID = field.NewString(tableName, "category_id")
	...
	_post.ShareCount = field.NewInt32(tableName, "share_count")
	_post.State = field.NewInt32(tableName, "state")
...
type post struct {
	...
	CategoryID   field.String // 隶属哪个归档
	...
	ShareCount   field.Int32  // 分享数量
	State        field.Int32  // 文章状态：0审核中、1通过、2被举报、3热点文章
...
func (p *post) updateTableName(table string) *post {
	...
	p.ShareCount = field.NewInt32(table, "share_count")
