...
type PostTag struct {
	...
	TagID     string         `gorm:"column:tag_id;type:char(36);comment:文章所属标签" json:"tag_id"`                         // 文章所属标签
	PostID    string         `gorm:"column:post_id;type:char(36);comment:博文id" json:"post_id"`                         // 博文id
}
