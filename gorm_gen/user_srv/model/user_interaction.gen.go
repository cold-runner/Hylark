...
type UserInteraction struct {
	...
	UserID     string         `gorm:"column:user_id;type:char(36);not null;comment:subject" json:"user_id"`             // subject
	FollowedID string         `gorm:"column:followed_id;type:char(36);not null;comment:object" json:"followed_id"`      // object
}
